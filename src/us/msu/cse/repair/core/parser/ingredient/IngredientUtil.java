...
public class IngredientUtil {
	...
	static int getMethodMatchDegree(Map.Entry<String, MethodInfo> entry1, Map.Entry<String, MethodInfo> entry2) {
		...
		String ps1 = mi1.getParameterTypeNames(0);

		MethodInfo mi2 = entry2.getValue();
		String ps2 = mi2.getParameterTypeNames(0);
	...
	public static boolean isInMethodScope(ModificationPoint mp, VarMethodInfoExtractor sie) {
	...
	public static boolean isInVarScope(ModificationPoint mp, VarMethodInfoExtractor sie) {
